...
\begin{figure}[h!]
\begin{center}
	\includegraphics[scale=0.28]{trieves.jpg}
\end{center}
\end{figure}
...
Créer une ferme en agroécologie, économiquement viable, autonome et centrée sur les céréales avec transformation en farine et en pain.
}}
\hspace{1cm}
...
\begin{figure}[h!]
\begin{center}
	\includegraphics[scale=0.35]{climate-graph.png}
...
\begin{figure}[h!]
\begin{center}
	\includegraphics[scale=0.3]{moulin.jpg}
...
\begin{figure}[h!]
\begin{center}
	\includegraphics[scale=0.5]{flux_physique_boulangerie2.pdf}
...
\begin{figure}[h!]
\begin{center}
	\includegraphics[scale=0.5]{20200521_BPREA_orga_boulange.pdf}
...
\footnotesize
\center
\begin{tabular}{ | p{3,5cm} | p{3cm}| p{1cm}| p{1,5cm}|p{2cm}| p{2,5cm}|}
\hline
...
\noindent\fbox{\parbox{\linewidth\fboxrule-2\fboxsep}{
\textbf{Bénéfice} = Chiffre d'affaire - charges variables - charges de structure - amortissement - intérêts d'emprunt  = $\sim$\textbf{40 000\euro{}}}}
...
\begin{figure}[h!]
\begin{center}
	\includegraphics[scale=0.9]{temps_travail.pdf}
